...
USE_ADAPTIVE_DECEPTION = os.getenv("AHRAS_USE_ADAPTIVE_DECEPTION", "true").lower() == "true"
DECEPTION_VALUE_THRESHOLD = float(os.getenv("AHRAS_DECEPTION_VALUE_THRESHOLD", "0.20"))
USE_RESPONSE_EFFICACY_LEARNER = os.getenv("AHRAS_USE_RESPONSE_EFFICACY_LEARNER", "true").lower() == "true"
EFFICACY_PRIOR_WEIGHT = float(os.getenv("AHRAS_EFFICACY_PRIOR_WEIGHT", "5.0"))
EFFICACY_EXPLORATION_EPSILON = float(os.getenv("AHRAS_EFFICACY_EXPLORATION_EPSILON", "0.05"))
MAX_AUTONOMOUS_BLAST_RADIUS = float(os.getenv("AHRAS_MAX_AUTONOMOUS_BLAST_RADIUS", "0.55"))
USE_PSEUDO_LABEL_LEARNER = os.getenv("AHRAS_USE_PSEUDO_LABEL_LEARNER", "true").lower() == "true"
PSEUDO_CONF_HIGH = float(os.getenv("AHRAS_PSEUDO_CONF_HIGH", "0.95"))
PSEUDO_CONF_LOW = float(os.getenv("AHRAS_PSEUDO_CONF_LOW", "0.05"))
PSEUDO_MAX_UNCERTAINTY = float(os.getenv("AHRAS_PSEUDO_MAX_UNCERTAINTY", "0.10"))
PSEUDO_MAX_OOD = float(os.getenv("AHRAS_PSEUDO_MAX_OOD", "0.20"))
PSEUDO_SAMPLE_WEIGHT = float(os.getenv("AHRAS_PSEUDO_SAMPLE_WEIGHT", "0.50"))
PSEUDO_BUFFER_CAPACITY = int(os.getenv("AHRAS_PSEUDO_BUFFER_CAPACITY", "200"))
